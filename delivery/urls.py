...
urlpatterns = [
    ...
    path('increase_cart/<int:item_id>/<str:username>', views.increase_cart, name='increase_cart'),
    path('decrease_cart/<int:item_id>/<str:username>', views.decrease_cart, name='decrease_cart'),
